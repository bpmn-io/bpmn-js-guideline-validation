                    ...
                    if ((0 < lambda && lambda < 1) && (0 < gamma && gamma < 1)) {
                        ...
                        if (!alreadyTracked) {
                            this.addValidationError({
                                ...
                                notification: 'Crossing sequence flows on element:',
                                html: validationHTMLCode.CROSSING_FLOWS_HTML
                            });
                        }
                    }
                }
...
CrossingFlowValidation.$inject = ['elementRegistry'];