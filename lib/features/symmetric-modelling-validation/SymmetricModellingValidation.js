            ...
            if (joinGateway.type !== splitGateway.type) {
                ...
                if (!alreadyTracker) {
                    this.addValidationError({
                        ...
                        notification: 'Wrong closing gateway on element:',
                        html: validationHTMLCode.SYMMETRIC_MODELING_HTML
                    });
                }
            }
        })
...
SymmetricModellingValidation.$inject = ['elementRegistry'];