...
export default class UseOfParallelGatewayValidation extends ValidationModule {
    ...
    constructor(elementRegistry) {
        super()
        this.name = 'Use of Parallel Gateway';
        ...
        elements.forEach(element => {
            if (moreThanOneIncomingSequenceflows(element) && moreThanOneOutgoingSequenceflows(element)) {
                this.addValidationError({
                    ...
                    notification: 'Multiple incoming flows on element:',
                    html: validationHTMLCode.MULTIPLE_INCOMING_HTML
                });
                this.addValidationError({
                    element: element,
                    errorType: validationErrorCodes.MULTIPLE_FLOW_ON_ELEMENT,
                    notification: 'Multiple outgoing flows on element:',
                    html: validationHTMLCode.MULTIPLE_OUTGOING_HTML
                });
...
UseOfParallelGatewayValidation.$inject = ['elementRegistry'];