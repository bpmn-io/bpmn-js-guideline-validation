...
export default class ValidationMenu {
    ...
    constructor(eventBus, canvas, selection, validationModuleController) {
        const self = this;
    ...
    _init() {
        this.container = domify(`
          <div class="toggle-validation">
            Guideline Validation <span class="toggle"><i class="gv-toggle-off"></i></span>
          </div>
        `);
...
ValidationMenu.$inject = ['eventBus', 'canvas', 'selection', 'validationModuleController']